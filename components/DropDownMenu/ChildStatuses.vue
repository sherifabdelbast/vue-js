...
<template>
  <div class="position-relative">
    <div class="py-1 px-3 rounded-1 fw-bold fs-8 text-uppercase text-nowrap cursor-default" v-can:not="{perms: 'edit issue', location: appStore.permissionLocation}"
    ...
    <div v-else @click="getStatuses" v-can="{perms: 'edit issue', location: appStore.permissionLocation}"
    ...
    <Transition name="statusesMenu">
      <div v-click-outside="closeStatuses" v-if="statusesOpen" v-can="{perms: 'edit issue', location: appStore.permissionLocation}"
